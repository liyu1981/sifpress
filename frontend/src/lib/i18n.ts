...
const en = {
  ...
  agent: {
    ...
    chatHint: 'Ask the agent to search your content, draft a page, or answer a question.',
    send: 'Send',
    stop: 'Stop',
    emptyTitle: 'Your local agent',
    emptyDescription:
      'Runs entirely in this browser. Search and read your pages, draft and update content, fetch web pages, or just chat.',
    thinking: 'Thinking…',
    toolDone: 'Done',
    toolError: 'Failed',
    usedTool: 'Used {{tool}}',
    ...
    modelUnknown: 'Model unavailable',
...
const zh = {
  ...
  agent: {
    ...
    chatHint: '让智能体搜索你的内容、起草页面，或回答问题。',
    send: '发送',
    stop: '停止',
    emptyTitle: '你的本地智能体',
    emptyDescription:
      '完全在浏览器中运行。搜索并阅读你的页面、起草和更新内容、抓取网页，或直接聊天。',
    thinking: '思考中…',
    toolDone: '完成',
    toolError: '失败',
    usedTool: '使用了 {{tool}}',
